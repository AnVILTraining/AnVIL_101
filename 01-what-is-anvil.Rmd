...
```{r, echo=FALSE, out.width="80%", fig.alt="Diagram showing screenshots of 4 important analysis tools that can run on AnVIL: Jupyter, Galaxy, RStudio, WDL, All of Us + AnVIL Imputation Service, and seqr.", fig.align="center"}
ottrpal::include_slide( "https://docs.google.com/presentation/d/1vJebvBQH_U80gDBvj_1d0USMnhaB3jiavWTLQDhgRuw/edit?slide=id.g409dedcc563_0_1055#slide=id.g409dedcc563_0_1055" )
```
