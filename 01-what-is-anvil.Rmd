...
```{r, echo=FALSE, out.width="100%", fig.alt="Examples of high-profile publications powered by AnVIL. In particular work by the Telomere-to-Telomere is highlighted.", fig.align="center"}
