...
Welcome to AnVIL 101! This book is a companion to the [virtual AnVIL101 workshop](https://training.anvilproject.org/anvil101.html), containing a walkthrough of the material. You can work through this book on your own, or you can:

- Join us for an [upcoming workshop](https://training.anvilproject.org/anvil101.html)
- Watch a [recording](https://www.youtube.com/watch?v=LKoOEpA8NMk) of past workshop
...
![](assets/Training_roadmap_sketch.png)

This book gives a brief tour of the AnVIL ecosystem and walks through the basics of setting up a compute environment on AnVIL. If you have never used AnVIL before, this is a great place to start!
...
::: {.warning}
This book walks you through the basics of using AnVIL, which requires you to have an active Billing Project. Billing Projects pay for the computing resources that you use. If you join us for a [live AnVIL 101 virtual workshop](https://training.anvilproject.org/anvil101.html), we will take care of the Billing Project for you.
